...
import { getBalanceOfContract } from '../util/queryChain';
...
function Login() {
        ...
        if (code && !error && !user) {
            ...
            instance
                ...
                .then(({ data }) => {
                    ...
                    return signInWithCustomToken(auth, data.body).then(
                ...
                .catch((e) => {
                    ...
                    if (e?.response?.status === 403) {
                        ...
                        setError(
                            'Something went wrong, please try again. You may also try using a VPN program, and not a VPN in your browser (as people in Russia are  currently banned by Google). Some anti-virus programs like Bullguard can block the site, so unblock it there.'
                        );
                    }
                })
                .finally(() => {
    ...
    const handle_nft_click = () =>
        getBalanceOfContract().then((value) => setButtonText(value));
        ...
        <>
            {!loading ? (
                <>
                            ...
                            <IonRow>
                                <IonCol size="6">
                                    <div className="ion-text-right">
                                        <IonButton
                                            href="#"
                                            className="iosButton ionTextRight"
                                            fill="clear"
                                            onClick={() => {
                                                window.open(
                                                    `https://apps.apple.com/in/app/sol-decoder/id1619922481`
                                                );
                                            }}
                                        >
                                            <img src={IosLogo} />
                                ...
                                <IonCol size="6">
                                    <IonButton
                                        href="#"
                                        className="androidButton ionTextLeft"
                                        fill="clear"
                                        onClick={() => {
                                            window.open(
                                                `https://play.google.com/store/apps/details?id=com.soldecoder.app`
                                            );
                                        }}
                                    >
                                        <img src={AndroidLogo} />
                    ...
                    <div
                        className={`flex ${
                            isMobileDevice ? 'flex-col' : 'flex-row'
                        }`}
                    >
                        <div
                            className={` ${
                                isMobileDevice ? 'w-full mt-4' : 'w-1/3 mt-10'
                            }`}
                        >
                            <div
                                className={`${
                                    isMobileDevice ? 'text-center' : ''
                                }`}
                            >
                            ...
                            <div
                                className={`flex flex-col mr-2 ${
                                    isMobileDevice ? 'mt-6 mr-0' : 'mt-10'
                                }`}
                            >
                        ...
                        <div
                            className={`login-right-side-wrapper w-full justify-center flex flex-col rounded-md ${
                                isMobileDevice
                                    ? 'pl-4 mt-4 pb-4 pt-4 pr-2'
                                    : 'pl-10 pr-4'
                            }`}
                            style={{ height: isMobileDevice ? 'auto' : '' }}
                        >
                            {/*this is the error msg at top! no delete!*/}
                            <p className="text-red-500 my-4 text-xl">{error}</p>
                            ...
                            <div className={`title-text flex flex-col mt-4`}>
                                <span>
                                    Use of the site / apps is locked to holders
                                    of one of our NFTs,{' '}
                                    <a
                                        href="https://magiceden.io/marketplace/soldecoder"
                                        className="underline"
                                        target="_blank"
                                    >
                                        which you can purchase on the left.
                                    </a>{' '}
                                </span>
                                <br />
                                <span>
                                    After purchasing one, please join{' '}
                                    <a
                                        href="https://discord.gg/sol-decoder"
                                        target="_blank"
                                        style={{ textDecoration: 'underline' }}
                                    >
                                        our Discord
                                    </a>{' '}
                                    and verify to get a role which allows access
                                    to the site / apps.
                                </span>
                                <br />
                                ...
                                <span>
                                    ...
                                    Follow us{' '}
                                    <a
                                        href="https://twitter.com/SOL_Decoder"
                                        target="_blank"
                                        className="underline"
                                    >
                                        on Twitter
                                        <IonIcon
                                            icon={logoTwitter}
                                            className="big-emoji ml-1"
                                        />
                                    </a>
                                </span>
                                <span>
                                    Read a Twitter thread of what we do{' '}
                                    <a
                                        href="https://twitter.com/SOL_Decoder/status/1516759793884712965 "
                                        target="_blank"
                                        className="underline"
                                    >
                                        here
                                ...
                                <span>
                                    Read our{' '}
                                    <a
                                        href="https://docs.soldecoder.app"
                                        target="_blank"
                                        className="underline"
                                    >
                                        docs here
                                ...
                                <div>
                                    View our official YouTube channel to view
                                    videos about our website / Discord{' '}
                                    <a
                                        href="https://www.youtube.com/playlist?list=PLeuijfzk0Wfv3rgrurWKo26l7rNy4lJE_"
                                        target="_blank"
                                        className="underline"
                                    >
                                        here{' '}
                                ...
                                <span>
                                    ...
                                    <IonRouterLink
                                        href="/privacy"
                                        className="pr-7 underline text-inherit"
                                    >
                                        Privacy Policy & ToS
                                    </IonRouterLink>{' '}
                                </span>
                                ...
                                <br />
                                <span>
                                    Full access to SOL Decoder is only available
                                    to those holding one of our NFTs. If you
                                    still want to click around the site to see
                                    what we offer, then try out the demo below.
                                    Note that you will only see old data, and
                                    some features are disabled.
                                </span>

                                <div
                                    className={`mt-4 mb-5 flex ${
                                        isMobileDevice
